...
<head>
	...
	session_start();
		...
		if (isset($_POST['managerLogin']))
		{
			...
			// background: url(images/banking_wp.jpg);
...
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right:725px">
	<br><h4 class="text-center">Login As</h4>
    ...
    <div class="card-header" role="tab" id="headingOne">
      <h5 class="mb-0">
        <a style="text-decoration: none;" data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
         <button class="btn btn-outline-primary btn-block">User</button>
        </a>
      </h5>
    </div>
